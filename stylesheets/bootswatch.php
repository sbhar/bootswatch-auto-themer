...
<div class="form-group">
	<div class='input-group date' id='datetimepicker1'>
		<input type='text' class="form-control date_text_box" />
...
<br/>
<p class="new_info_cont">Please select a file to upload</p>
...
<hr>
	...
	<script type="text/javascript">
		$(function () {
			...
			var file_upload = location.href.split('=')[1];
			if(file_upload===undefined){
				$('.new_info_cont').html('Please select file to upload');
			}else{
				$('.new_info_cont').html('File uploaded: ' + file_upload);
			}
			
			$('#datetimepicker1').datetimepicker();
			$('.date_text_box').click(function(){
